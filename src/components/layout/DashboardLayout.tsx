  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-muted/40">
      ...
      <div className="flex flex-1 flex-col min-w-0 min-h-0">
        <div className="flex flex-1 flex-col min-h-0 px-0 sm:px-4 md:px-6 sm:py-4">
          <div className="flex flex-1 flex-col min-h-0 rounded-none sm:rounded-xl sm:border sm:border-border sm:bg-background sm:shadow-sm overflow-hidden">
            <DashboardHeader />
            <main
